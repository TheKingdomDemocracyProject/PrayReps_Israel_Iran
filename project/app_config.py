...
APP_ROOT = os.path.dirname(os.path.dirname(os.path.abspath(__file__))) # This will point to the directory containing 'project'
...
HEART_IMG_PATH = 'static/heart_icons/heart_red.png' # Path for map plotting logic in app.py
